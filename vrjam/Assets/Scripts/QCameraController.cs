...
//
public class QCameraController : OVRComponent
{
	// PRIVATE MEMBERS
	...
	private float   YRotationOffset = 0.0f;
	private float   XRotationOffset = 0.0f;
	...
	bool ConfigureCamera(ref Camera camera, float distOffset, float perspOffset, float eyePositionOffset)
	{
		...
		camera.GetComponent<QCamera>().SetPerspectiveOffset(ref PerspOffset);
		...
		// accurate
		camera.GetComponent<QCamera>().NeckPosition = NeckPosition;
		EyePosition.x = eyePositionOffset;

		camera.GetComponent<QCamera>().EyePosition = EyePosition;
	...
	// Get/SetXRotationOffset
	public void GetXRotationOffset(ref float xRotationOffset)
	{
		xRotationOffset = XRotationOffset;
	}
	public void SetXRotationOffset(float xRotationOffset)
	{
		XRotationOffset = xRotationOffset;
	}

	// Get/SetYRotationOffset
	public void GetYRotationOffset(ref float yRotationOffset)
	{
		yRotationOffset = YRotationOffset;
	}
	public void SetYRotationOffset(float yRotationOffset)
	{
		YRotationOffset = yRotationOffset;
	}
